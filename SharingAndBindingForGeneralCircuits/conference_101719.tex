...
Desweiteren folgt der Verträglichkeitsgraph der Alu. Ein eindeutiges ergebnis ist hier allerdings nicht auf den ersten blick zu sehen, das zeigt, wie schnell selbst sehr siple verschaltungen, sehr komplizierte ausmaße bekommen können. Um dieses Problem zu minimieren wird im weiteren vorgehen mit einer einteilung in sogenannte cliquen gearbeitet. Diese cliquen werden dann farbig im Verträglichkeitsgraph eingezeichnet. 

\begin{figure}[h]
\center{\includegraphics[scale=0.55]{fig_comp_mult_cliq}}
...
\caption{Verträglichkeitsgraph Arithmetisch Logische Einheit}
\label{fig.3}
\end{figure}
